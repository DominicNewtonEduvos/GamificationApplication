...
public class AddAndViewInformation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, pdfNames);
    ...
    private void loadPdfFromUri(Uri uri) {
        try {
            ...
            displayView.setText("Failed to read PDF file. It might have been moved or deleted.");
